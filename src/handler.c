...
static void _id_handler_add(xmpp_conn_t *const conn, xmpp_handler handler,
 ...
 *  @ingroup Handlers
 */
void xmpp_id_handler_delete(xmpp_conn_t *const conn, xmpp_handler handler,
                            const char *const id)
{
...
static void _handler_add(xmpp_conn_t *const conn, xmpp_handler handler,
 ...
 *  @ingroup Handlers
 */
void xmpp_timed_handler_add(xmpp_conn_t *const conn, xmpp_timed_handler handler,
                            const unsigned long period, void *const userdata)
{
 ...
 *  @ingroup Handlers
 */
void xmpp_id_handler_add(xmpp_conn_t *const conn, xmpp_handler handler,
                         const char *const id, void *const userdata)
{
