...
static void crypto_HMAC(const struct hash_alg *alg, const uint8_t *key, size_t key_len,
                             const uint8_t *text, size_t len, uint8_t *digest)
{
...
static void SCRAM_Hi(const struct hash_alg *alg, const uint8_t *text, size_t len, const uint8_t *salt,
                          size_t salt_len, uint32_t i, uint8_t *digest)
{
    size_t k;
    uint32_t j;
    uint8_t tmp[128];
...
void SCRAM_ClientKey(const struct hash_alg *alg, const uint8_t *password, size_t len,
...
void SCRAM_ClientSignature(const struct hash_alg *alg, const uint8_t *ClientKey,
...
void SCRAM_ClientProof(const struct hash_alg *alg, const uint8_t *ClientKey,
