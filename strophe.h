...
int xmpp_connect_raw(xmpp_conn_t *const conn, const char *const altdomain,
                     unsigned short altport, xmpp_conn_handler callback,
                     void *const userdata);
...
int xmpp_stanza_to_text(xmpp_stanza_t *stanza, char **const buf,
                        size_t *const buflen);
...
int xmpp_stanza_set_text_with_size(xmpp_stanza_t *stanza,
                                   const char *const text, const size_t size);
...
char *xmpp_base64_encode(xmpp_ctx_t *ctx, const unsigned char *data,
                         size_t len);
